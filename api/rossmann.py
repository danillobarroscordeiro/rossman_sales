...
class Rossmann(object):
    def __init__(self):
        ...
        self.year_scaler                                      = pickle.load(open(self_home_path + 'parameter/year_scaler.pkl', 'rb') )
        self.store_type_scaler                           = pickle.load(open(self_home_path + 'parameter/store_type_scaler.pkl', 'rb') )
